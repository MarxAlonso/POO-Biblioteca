...
public class FormGraficaVentas extends javax.swing.JInternalFrame {
    ...
    private int MetodoContador() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select fechaVenta, count(fechaVenta) as Ventas from cabeceraventa "
                    + "where fechaVenta BETWEEN '" + FormFechasGraficas.fecha_inicio + "' and '" + FormFechasGraficas.fecha_fin + "' group by fechaVenta;");
...
//    Metodo para dterminar cual es el dia de mahyor cantidad de ventas
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(242, 205, 136));
        setClosable(true);
        setResizable(true);
